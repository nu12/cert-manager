class ApplicationController < ActionController::Base
  ...
  private
    def redirect_certificate certificate
      ...
      return redirect_to certificates_root_intermediate_server_path(certificate.parent.parent, certificate.parent, certificate), notice: "Server certificate was successfully created." if certificate.type == :server
    end
end
